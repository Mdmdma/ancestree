...
import { isPartnerEdge, isBloodlineNode, validateConnection } from './connectionValidation';
...
// isPartnerEdge imported from connectionValidation.js
...
// isBloodlineNode and validateConnection imported from connectionValidation.js
          ...
          if (sourceNode.type === 'person') {
            if (sourceHandle === 'parent' || sourceHandle === 'child') {
              ...
              const familyNodeData = {
                ...
                housenumber: sourceNode.data.housenumber || '',
                city: sourceNode.data.city || '',
                zip: sourceNode.data.zip || '',
                country: sourceNode.data.country || '',
                latitude: sourceNode.data.latitude || '',
                longitude: sourceNode.data.longitude || '',
                addressHash: sourceNode.data.addressHash || '',
